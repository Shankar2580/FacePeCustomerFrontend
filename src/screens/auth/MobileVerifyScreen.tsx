...
export default function MobileVerifyScreen() {
  ...
  const handleVerify = async (verificationCode?: string) => {
    ...
    if (fullCode.length !== 6) {
      showAlert('Invalid Code', 'Please enter the complete 6-digit code', [{ text: 'OK' }], 'warning');
      return;
    }
    ...
    if (success) {
      ...
      showAlert('Invalid Code', 'Please check your code and try again', [{ text: 'OK' }], 'error');
    }
  };
  ...
  const handleResend = async () => {
    ...
    if (success) {
      showAlert('Code Sent', 'A new verification code has been sent to your phone', [{ text: 'OK' }], 'success');
    } else {
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              ...
              <Text 
                ...
                onPress={() => showAlert('Support', 'Contact support for help', [{ text: 'OK' }], 'info')}
              >
                Contact Support
              </Text>
            </Text>
